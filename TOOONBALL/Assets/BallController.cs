...
public class BallController : NetworkBehaviour
{
    ...
    public PlayerController currentPlayer; // Burayı 'public' yaptık 🚀
    ...
    public void AssignBall(PlayerController player)
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            AssignBall(other.GetComponent<PlayerController>());
        }
    }
